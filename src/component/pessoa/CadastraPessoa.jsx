...
class AddPessoaComponent extends Component{     
    ...
    componentDidMount() {
      ...
      let estadosIn = [ {Sigla: 'SP', Nome: 'São Paulo'}, 
      {Sigla: 'PR', Nome: 'Paraná'}, 
      {Sigla: 'RJ', Nome: 'Rio de Janeiro'},
      {Sigla: 'SC', Nome: 'Santa Catarina'}];
      ApiService.addEstados(estadosIn);
    ...
    savePessoa = (e) => {
        e.preventDefault();
        let pessoa = { IdStatus: this.state.IdStatus,
    ...
    render() {
        return(
            <div style={styleDiv}>
                <Typography variant="h4" style={style}>Cadastrar Pessoa</Typography>
